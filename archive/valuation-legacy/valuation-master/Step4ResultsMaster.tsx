...
import ReferralPrompt from '../valuation/ReferralPrompt';
import { supabase } from '@/integrations/supabase/client';
import { getPreferredLang } from '@/shared/i18n/locale';
import { useI18n } from '@/shared/i18n/I18nProvider';
import { formatCurrency } from '@/shared/utils/format';

interface Step4MasterProps {
  result: any;
  companyData: any;
...
const Step4ResultsMaster: React.FC<Step4MasterProps> = ({ result, companyData, isCalculating, resetCalculator }) => {
...
export default Step4ResultsMaster;
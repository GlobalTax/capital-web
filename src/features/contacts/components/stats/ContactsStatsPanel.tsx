...
// Panel principal de estadísticas con costes

import React, { useState } from 'react';
import { format, subDays, subMonths, startOfMonth, endOfMonth, startOfWeek, endOfWeek } from 'date-fns';
import { es } from 'date-fns/locale';
import { Calendar, BarChart3, TrendingUp, Euro, CircleOff, RefreshCw } from 'lucide-react';
...
export const ContactsStatsPanel: React.FC = () => {
  ...
  const handleRefresh = async () => {
    ...
    // Trigger refetch by changing dates slightly
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-0.5">
            Análisis de leads, conversiones y costes de adquisición
          </p>
        </div>

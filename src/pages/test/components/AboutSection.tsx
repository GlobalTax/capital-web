...
const StatCounter: React.FC<StatItem & { delay: number }> = ({ 
  ...
  return (
    <div ref={ref} className="text-center md:text-left">
      <div className="text-slate-900 text-4xl md:text-5xl lg:text-6xl font-light tracking-tight">
        {prefix}{count}{suffix}
      </div>
      <div className="text-slate-500 text-sm mt-2 tracking-wide uppercase">
        {label}
      </div>
    </div>
  );
...
const AboutSection: React.FC = () => {
  return (
    <section id="la-firma" className="py-24 md:py-32 bg-white">
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-6 mb-10">
              <div className="border-l-2 border-slate-200 pl-4">
                <h4 className="text-slate-900 font-medium mb-1">Confidencialidad</h4>
                <p className="text-slate-500 text-sm">Máxima discreción en cada operación</p>
              </div>
              <div className="border-l-2 border-slate-200 pl-4">
                <h4 className="text-slate-900 font-medium mb-1">Independencia</h4>
                <p className="text-slate-500 text-sm">Asesoramiento objetivo y transparente</p>
              </div>
            </div>
            ...
            <a
              href="#equipo"
              className="inline-flex items-center gap-3 text-slate-900 text-sm font-medium tracking-wide hover:text-slate-600 transition-colors group"
            >
              Conocer al equipo
              <svg 
        ...
        <motion.div
          ...
          className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12 mt-20 pt-16 border-t border-slate-200"
        >

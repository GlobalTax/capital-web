...
const Tecnologia = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section className="pt-32 pb-20 bg-gradient-to-r from-purple-900 to-indigo-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-purple-100 max-w-3xl mx-auto mb-8">
              Especialistas en M&A para empresas tecnológicas, desde startups innovadoras 
              hasta corporaciones tech establecidas.
            </p>
            <Button className="capittal-button text-lg px-8 py-4 bg-white text-black hover:bg-gray-100">
              Explorar Oportunidades Tech
            </Button>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-purple-50 p-8 rounded-lg">
              <Award className="w-16 h-16 text-purple-600 mb-6" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div>
              ...
              <div className="text-purple-300">Valor de Transacción</div>
            </div>
            <div>
              <div className="text-3xl font-bold text-white mb-2">8x ARR</div>
              <div className="text-purple-300">Múltiplo Alcanzado</div>
            </div>
            <div>
              <div className="text-3xl font-bold text-white mb-2">50K+</div>
              <div className="text-purple-300">Usuarios Activos</div>
            </div>
          </div>

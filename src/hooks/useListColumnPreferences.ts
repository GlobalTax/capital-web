...
const DEFAULT_COLUMNS: ListColumnDef[] = [
  ...
  { key: 'descripcion_actividad', label: 'Descripción', visible: true, position: 4, minWidth: '250px' },
  { key: 'contacto', label: 'Contacto', visible: true, position: 5 },
  { key: 'email', label: 'Email', visible: true, position: 6 },
  { key: 'linkedin', label: 'LinkedIn', visible: true, position: 7 },
  { key: 'director_ejecutivo', label: 'Director Ejecutivo', visible: true, position: 8 },
  { key: 'web', label: 'Web', visible: true, position: 9 },
  { key: 'provincia', label: 'Provincia', visible: true, position: 10 },
  { key: 'facturacion', label: 'Facturación', visible: true, position: 11, sortable: true, align: 'right' },

...
const DEFAULT_COLUMNS: ListColumnDef[] = [
  ...
  { key: 'descripcion_actividad', label: 'Descripción', visible: true, position: 3, minWidth: '250px' },
  { key: 'contacto', label: 'Contacto', visible: true, position: 4 },
  { key: 'email', label: 'Email', visible: true, position: 5 },
  { key: 'linkedin', label: 'LinkedIn', visible: true, position: 6 },
  { key: 'director_ejecutivo', label: 'Director Ejecutivo', visible: true, position: 7 },
  { key: 'web', label: 'Web', visible: true, position: 8 },
  { key: 'provincia', label: 'Provincia', visible: true, position: 9 },
  { key: 'facturacion', label: 'Facturación', visible: true, position: 10, sortable: true, align: 'right' },
  { key: 'ebitda', label: 'EBITDA', visible: true, position: 11, sortable: true, align: 'right' },
  { key: 'num_trabajadores', label: 'Empleados', visible: true, position: 12, sortable: true, align: 'right' },
  { key: 'consolidador', label: 'Consolidador', visible: true, position: 13, minWidth: '180px' },
  { key: 'notas', label: 'Notas', visible: true, position: 14, minWidth: '160px' },

...
const Services = () => {
  ...
  const coreServices = [
    ...
    },
    {
      ...
      description: 'Te ayudamos a identificar, evaluar y adquirir empresas estratégicas que impulsen tu crecimiento. Proceso integral desde la búsqueda hasta el cierre.',

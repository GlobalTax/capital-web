      ...
      <div className="container max-w-6xl mx-auto px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-20 py-8 border-t border-b border-border">
          <div className="text-center">
            <div className="text-3xl font-medium text-foreground mb-2">70+</div>
            <div className="text-muted-foreground font-normal text-base">Profesionales</div>
          </div>
          
          <div className="text-center">
            <div className="text-3xl font-medium text-foreground mb-2">15+</div>
            <div className="text-muted-foreground font-normal text-base">Años Experiencia</div>
          </div>
          
          <div className="text-center">
            <div className="text-3xl font-medium text-foreground mb-2">4</div>
            <div className="text-muted-foreground font-normal text-base">Especialidades</div>
          </div>
          
          <div className="text-center">
            <div className="text-3xl font-medium text-foreground mb-2">100%</div>
            <div className="text-muted-foreground font-normal text-base">Dedicación</div>
          </div>
        </div>

        {/* Ecosystem Section */}
        <div className="mb-20 text-center">
          <h3 className="text-xl font-normal text-foreground mb-6 tracking-tight">
            Ecosistema Integral del Grupo Navarro
          </h3>
          <p className="text-muted-foreground max-w-4xl mx-auto leading-relaxed font-normal">

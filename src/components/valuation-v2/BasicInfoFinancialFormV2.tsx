          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <Input
                ...
                className={`pr-10 ${getFieldClass('contactName')}`}
              />
              {showValidation && getFieldState?.('contactName')?.isValid && getFieldState?.('contactName')?.isTouched && (
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <Input
                ...
                className={`pr-10 ${getFieldClass('email')}`}
              />
              {showValidation && getFieldState?.('email')?.isValid && getFieldState?.('email')?.isTouched && (
                <div className="absolute right-3 top-1/2 -translate-y-1/2 text-green-500">
                  <Check className="h-5 w-5" />
                </div>
              )}
          ...
          <div className="relative">
            <Input
              ...
              onChange={(e) => {
                ...
                updateField('phone_e164', value);
              }}
              onBlur={() => handleFieldBlur?.('phone')}
              placeholder="+34 600 000 000"
              className={`pr-10 ${getFieldClass('phone')}`}
            />
            {showValidation && getFieldState?.('phone')?.isValid && getFieldState?.('phone')?.isTouched && (
              <div className="absolute right-3 top-1/2 -translate-y-1/2 text-green-500">
                <Check className="h-5 w-5" />
              </div>
            )}
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <Input
                ...
                className={`pr-10 ${getFieldClass('companyName')}`}
              />
              {showValidation && getFieldState?.('companyName')?.isValid && getFieldState?.('companyName')?.isTouched && (
                <div className="absolute right-3 top-1/2 -translate-y-1/2 text-green-500">
                  <Check className="h-5 w-5" />
                </div>
              )}
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <Input
                ...
                className={`pr-10 ${getFieldClass('cif')}`}
              />
              {showValidation && getFieldState?.('cif')?.isValid && getFieldState?.('cif')?.isTouched && (
                <div className="absolute right-3 top-1/2 -translate-y-1/2 text-green-500">
                  <Check className="h-5 w-5" />
                </div>
              )}
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <Input
                ...
                placeholder="500.000"
                className={`pr-10 ${getFieldClass('revenue')}`}
              />
              {showValidation && getFieldState?.('revenue')?.isValid && getFieldState?.('revenue')?.isTouched && (
                <div className="absolute right-3 top-1/2 -translate-y-1/2 text-green-500">
                  <Check className="h-5 w-5" />
                </div>
              )}
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <Input
                ...
                placeholder="75.000"
                className={`pr-10 ${getFieldClass('ebitda')}`}
              />
              {showValidation && getFieldState?.('ebitda')?.isValid && getFieldState?.('ebitda')?.isTouched && (
                <div className="absolute right-3 top-1/2 -translate-y-1/2 text-green-500">
                  <Check className="h-5 w-5" />
                </div>
              )}

          ...
          <div className="col-span-1 md:col-span-2">
            <div className="mb-4">
              ...
              <p className="text-gray-400 text-xs mt-1">
                División de M&A de{' '}
                <a <a href="https://nvrro.es/" target="_blank" rel="noopener noreferrer" className="underline hover:text-white transition-colors"> target="_blank" rel="noopener noreferrer" className="underline hover:text-white transition-colors">
                  Navarro Tax &amp; Legal
                </a>
              </p>
            </div>

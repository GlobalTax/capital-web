      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {cases.length > 0 ? (
                ...
                <CardContent className="p-8">
                  ...
                  <h3 className="text-xl font-semibold text-black mb-4 leading-tight text-center group-hover:text-blue-700 transition-colors duration-200">
                    ...
                    <div className="space-y-3 mb-4">
                      ...
                      {case_.company_size && (
                        <div className="flex items-center justify-between">
                          <span className="text-sm text-gray-600">{t('cases.size')}</span>
                    ...
                    {case_.highlights && case_.highlights.length > 0 && (
                      <div className="space-y-2">
                        <h4 className="text-sm font-medium text-black mb-2">{t('cases.highlights')}</h4>
          ...
          <div className="text-center py-16">
            <p className="text-gray-600 text-lg">{t('cases.empty')}</p>
          </div>
        )}
      </div>
    </section>

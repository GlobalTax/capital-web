    ...
    <section className="py-20 bg-background">
      <div className="max-w-6xl mx-auto px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center px-4 py-2 bg-legal-accent text-legal-accent-foreground rounded-lg text-sm font-medium mb-6">
            La Diferencia Capittal
          </div>
          
          <h2 className="text-3xl md:text-4xl font-normal text-foreground mb-6 tracking-tight">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {reasons.map((reason, index) => (
            <div 
              key={index} 
              className="bg-card border border-border rounded-lg p-6 shadow-sm hover:shadow-md transition-all duration-300 ease-out group"
            >
              {/* Highlight */}

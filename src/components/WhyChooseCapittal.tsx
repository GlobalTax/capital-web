      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          {reasons.map((reason, index) => (
            <div 
              key={index} 
              className="bg-white rounded-2xl border border-gray-200 p-8 shadow-sm hover:shadow-xl transform hover:scale-105 transition-all duration-300 group"
            >
              {/* Icon and highlight */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="bg-gray-900 text-white rounded-2xl p-8 shadow-2xl">
            ...
            <div className="space-y-4">
              <Button className="capittal-button text-xl px-12 py-6 w-full shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300">
                Valoración Gratuita
              ...
              <Button 
                variant="outline" 
                className="bg-transparent border-0.5 border-white rounded-lg px-12 py-6 text-xl font-normal hover:bg-white hover:text-black transition-all duration-300 w-full"
              >
                Solicitar Reunión
              </Button>
            </div>

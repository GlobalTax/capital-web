    ...
    <section className="pt-32 pb-20 bg-gradient-to-b from-white to-gray-50/50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <h1 className="text-5xl md:text-6xl font-bold text-black mb-8 leading-tight max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            ...
            <div className="text-center">
              ...
              <div className="text-gray-600">Valor Total Transacciones</div>
            </div>
            <div className="text-center">
              <div className="text-4xl font-bold text-black mb-2">40%</div>
              <div className="text-gray-600">Superior al Mercado</div>
            </div>
          </div>
        </div>
      </div>

      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          ...
          <div className="lg:col-span-7">
            <div className="inline-flex items-center px-4 py-2 bg-orange-600 text-white rounded-lg text-sm font-medium mb-8">
            ...
            <div className="grid grid-cols-3 gap-8 mb-12 py-8 border-t border-b border-border">
              <div className="text-center">
                <div className="text-2xl font-bold text-orange-600 mb-2">€1.0B+</div>
            ...
            <div className="flex flex-col sm:flex-row gap-6">
              ...
              <Button variant="outline" className="bg-transparent border-0.5 border-orange-600 text-orange-600 px-12 py-6 font-normal hover:bg-orange-600 hover:text-white transition-all duration-300 shadow-sm text-sm rounded-lg">
                Ver Casos de Éxito
              </Button>
            </div>
          </div>
          ...
          <div className="lg:col-span-5">
            <div className="relative">
                ...
                <div className="p-6">
                  ...
                  <div className="mt-6 pt-6 border-t border-border">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="font-bold text-orange-600">47 activas</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              {/* Floating Stats */}
              <div className="absolute -top-4 -right-4 bg-orange-600 text-white rounded-lg p-4 shadow-lg">
                <div className="flex items-center space-x-2">
                  <div>
                    <div className="font-bold">+23%</div>
                    <div className="text-xs text-orange-100">Este mes</div>
                  </div>
                </div>
              </div>

  ...
  return (
    <section className="py-20 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
          {benefits.map((benefit, index) => (
            <div key={index} className="bg-white rounded-xl p-6 text-center hover:shadow-lg transition-shadow">
              <div className="text-3xl font-normal text-blue-600 mb-2">{benefit.stats}</div>
              <h3 className="text-lg font-normal text-slate-900 mb-3">{benefit.title}</h3>
        ...
        {/* Success Cases */}
        <div>
          <h3 className="text-2xl font-normal text-slate-900 text-center mb-12">
            ...
            {successCases.map((case_, index) => (
              <div key={index} className="bg-white rounded-xl p-6 border border-gray-200">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="text-xl font-normal text-slate-900">{case_.value}</span>
                </div>
                <h4 className="text-lg font-normal text-slate-900 mb-2">{case_.company}</h4>
        ...
        <div className="mt-16 bg-slate-900 rounded-2xl p-8 text-white text-center">
          <h3 className="text-2xl font-normal mb-8">Resultados que Hablan por Sí Solos</h3>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              <div className="text-3xl font-normal mb-2">€902M</div>
              <div className="text-sm text-gray-300">Valor total gestionado</div>
            </div>
            <div>
              <div className="text-3xl font-normal mb-2">98,7%</div>
              <div className="text-sm text-gray-300">Tasa de éxito en cierres</div>
            </div>
            <div>
              <div className="text-3xl font-normal mb-2">4.2x</div>

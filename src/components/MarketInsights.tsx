      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          {insights.map((insight, index) => (
            <Card key={index} className="bg-white border-0.5 border-black rounded-[10px] shadow-sm hover:shadow-lg hover:-translate-y-2 transition-all duration-300 ease-out text-center">
        ...
        <div className="bg-white border-0.5 border-black rounded-[10px] shadow-sm p-8 text-center">
          <h3 className="text-3xl font-bold text-black mb-4">
            Inteligencia de Mercado Capittal
          </h3>
          <p className="text-gray-600 mb-6 max-w-2xl mx-auto leading-relaxed text-lg">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Button 
              className="bg-white text-black border-0.5 border-black rounded-[10px] px-8 py-4 text-xl font-medium hover:shadow-lg hover:-translate-y-1 transition-all duration-300 ease-out"
            ...
            <Button 
              variant="outline" 
              className="bg-transparent border-0.5 border-black rounded-[10px] px-8 py-4 text-xl font-medium hover:bg-black hover:text-white transition-all duration-300"
            >
              Solicitar Acceso
            </Button>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8 text-left">
            <div>
              <h4 className="font-semibold text-black mb-2 text-lg">Valoraciones en Tiempo Real</h4>
              <p className="text-gray-600 text-base leading-relaxed">
                Metodologías DCF, múltiplos y transacciones comparables actualizadas diariamente.
              </p>
            </div>
            <div>
              <h4 className="font-semibold text-black mb-2 text-lg">Base de Datos M&A</h4>
              <p className="text-gray-600 text-base leading-relaxed">
                Acceso a más de 10,000 transacciones históricas con detalles financieros.
              </p>
            </div>
            <div>
              <h4 className="font-semibold text-black mb-2 text-lg">Analytics Avanzados</h4>
              <p className="text-gray-600 text-base leading-relaxed">

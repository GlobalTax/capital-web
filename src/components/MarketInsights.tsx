      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white border-0.5 border-black rounded-[10px] shadow-sm p-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Button 
              className="bg-white text-black border-0.5 border-black rounded-[10px] px-8 py-4 text-lg font-medium hover:shadow-lg hover:-translate-y-1 transition-all duration-300 ease-out"
            ...
            <Button 
              variant="outline" 
              className="bg-transparent border-0.5 border-black rounded-[10px] px-8 py-4 text-lg font-medium hover:bg-black hover:text-white transition-all duration-300"
            >
              Solicitar Acceso
            </Button>
          </div>

...
export const AdminSidebar: React.FC = () => {
  ...
  const getItemVisibility = (url: string): boolean => {
    ...
    const routePermissionMap: Record<string, keyof typeof menuVisibility> = {
      ...
      'landing-pages-unified': 'landingPages',
      ...
      // Rutas con acceso universal (mapeadas a 'dashboard')
      'content-calendar': 'dashboard',
      'search-analytics': 'dashboard',
      'cr-directory': 'dashboard',
      ...
      'cr-portfolio-list': 'dashboard',
      'sf-acquisitions': 'dashboard',
      'sector-intelligence': 'dashboard',
      'sector-dossiers': 'dashboard',
      'advisor-multiples': 'dashboard',
      'leads-pipeline': 'dashboard',
      'buy-pipeline': 'dashboard',
      'buyer-contacts': 'dashboard',
      'calculadora-manual': 'dashboard',
      'bookings': 'dashboard',
      'ndas': 'dashboard',
      ...
      'mna-directory': 'dashboard',
      'mna-apollo-import': 'dashboard',
      'noticias': 'dashboard',
      'apollo-visitors': 'dashboard',
      'dealsuite': 'dashboard',
      'campaign-costs': 'dashboard',
      'newsletter': 'dashboard',
      'brevo-import': 'dashboard',
      'venta-empresas-content': 'dashboard',

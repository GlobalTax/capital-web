...
export const dictionaries: Record<LangCode, Record<string, string>> = {
  es: {
    ...
    'operations.filters.datePublished': 'Fecha de publicación',
    'operations.filters.anyDate': 'Cualquier fecha',
    'operations.filters.lastWeek': 'Última semana',
    'operations.filters.lastMonth': 'Último mes',
    'operations.filters.last3Months': 'Últimos 3 meses',
    'operations.filters.status': 'Estado',
    'operations.filters.allStatuses': 'Todos los estados',
    'operations.filters.clearFilters': 'Limpiar filtros',
    'operations.filters.activeFilters': 'Filtros activos:',
    'operations.filters.clearAll': 'Limpiar todos',
    'operations.results.showing': 'Mostrando {count} de {total} operaciones',
    'operations.pagination.previous': 'Anterior',
    'operations.pagination.next': 'Siguiente',
    'operations.pagination.page': 'Página {current} de {total}',
    'operations.pagination.viewAll': 'Ver todas',
    'operations.pagination.backToPagination': 'Volver a paginación',
    'operations.pagination.loading': 'Cargando...',
    'operations.alert.limitReached': 'Se muestran las primeras {max} operaciones de {total} totales. Usa los filtros para refinar tu búsqueda.',
    'operations.status.active': 'Activo',
    'operations.status.upcoming': 'Próximamente',
    'operations.status.exclusive': 'En exclusividad',
    'operations.tooltip.removeCompare': 'Quitar de comparación',
    'operations.tooltip.addCompare': 'Añadir a comparación',
    'operations.tooltip.maxCompare': 'Máximo 4 operaciones',
    'operations.tooltip.removeWishlist': 'Quitar de la cesta',
    'operations.tooltip.addWishlist': 'Añadir a la cesta',
    'operations.badges.featured': 'Destacado',
    'operations.badges.new': 'Nuevo',
    'operations.card.revenue': 'Facturación',
    'operations.card.ebitda': 'EBITDA',
    'operations.card.inquire': 'Consultar',
    'operations.card.year': 'Año',
    'operations.card.employees': 'Empleados',
    'operations.dealType.sale': 'Venta',
    'operations.dealType.acquisition': 'Adquisición',
    ...
    'buyerTestimonials.subtitle': 'Inversores y empresarios que han encontrado su empresa ideal a través de Capittal',
  ...
  en: {
    ...
    'buyerTestimonials.subtitle': 'Investors and entrepreneurs who found their ideal company through Capittal',
    ...
    // Operations Page Filters (EN)
    'operations.filters.title': 'Filters & Search',
    'operations.filters.sortBy': 'Sort by',
    'operations.filters.mostRecent': 'Most recent',
    'operations.filters.year': 'Year',
    'operations.filters.valuation': 'Valuation',
    'operations.filters.name': 'Name',
    'operations.filters.valuationMin': 'Min valuation (€k)',
    'operations.filters.valuationMax': 'Max valuation (€k)',
    'operations.filters.datePublished': 'Publication date',
    'operations.filters.anyDate': 'Any date',
    'operations.filters.lastWeek': 'Last week',
    'operations.filters.lastMonth': 'Last month',
    'operations.filters.last3Months': 'Last 3 months',
    'operations.filters.status': 'Status',
    'operations.filters.allStatuses': 'All statuses',
    'operations.filters.clearFilters': 'Clear filters',
    'operations.filters.activeFilters': 'Active filters:',
    'operations.filters.clearAll': 'Clear all',
    'operations.results.showing': 'Showing {count} of {total} operations',
    'operations.pagination.previous': 'Previous',
    'operations.pagination.next': 'Next',
    'operations.pagination.page': 'Page {current} of {total}',
    'operations.pagination.viewAll': 'View all',
    'operations.pagination.backToPagination': 'Back to pagination',
    'operations.pagination.loading': 'Loading...',
    'operations.alert.limitReached': 'Showing first {max} of {total} operations. Use filters to refine your search.',
    'operations.status.active': 'Active',
    'operations.status.upcoming': 'Upcoming',
    'operations.status.exclusive': 'In exclusivity',
    'operations.tooltip.removeCompare': 'Remove from comparison',
    'operations.tooltip.addCompare': 'Add to comparison',
    'operations.tooltip.maxCompare': 'Maximum 4 operations',
    'operations.tooltip.removeWishlist': 'Remove from cart',
    'operations.tooltip.addWishlist': 'Add to cart',
    'operations.badges.featured': 'Featured',
    'operations.badges.new': 'New',
    'operations.card.revenue': 'Revenue',
    'operations.card.ebitda': 'EBITDA',
    'operations.card.inquire': 'Inquire',
    'operations.card.year': 'Year',
    'operations.card.employees': 'Employees',
    'operations.dealType.sale': 'Sale',
    'operations.dealType.acquisition': 'Acquisition',

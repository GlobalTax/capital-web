...
export const calculateCompanyValuationMaster = async (
  companyData: CompanyDataMaster, 
  sectorMultiples: SectorMultipleMaster[]
): Promise<ValuationResultMaster> => {
  ...
  if (byEbitda && byEbitda.metric === 'EV/EBITDA') {
    ...
    const valuationResult: ValuationResultMaster = {

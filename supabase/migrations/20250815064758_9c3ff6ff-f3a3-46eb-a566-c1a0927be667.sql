-- Crear función que envía alerta cuando se detecta valoración incompleta
...
-- Crear trigger que se ejecuta después de insertar en company_valuations
CREATE TRIGGER trigger_incomplete_valuation_alert
  AFTER INSERT ON public.company_valuations
  FOR EACH ROW
  EXECUTE FUNCTION send_incomplete_valuation_alert();
...
SELECT public.log_security_event(
  'VISITOR_TRACKING_SECURITY_FIX',
  'high',
  'lead_behavior_events',
  'POLICY_UPDATE',
  jsonb_build_object(
    'description', 'Fixed public access vulnerability to visitor tracking data',
    'changes_made', 'Restricted SELECT access to admins only, enhanced INSERT validation',
    'timestamp', now()
  )
);
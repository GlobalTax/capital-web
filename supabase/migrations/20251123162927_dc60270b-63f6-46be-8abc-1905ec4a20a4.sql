-- Create RPC function for valuation analytics with SECURITY DEFINER
CREATE OR REPLACE FUNCTION get_valuation_analytics(
...
GRANT EXECUTE ON FUNCTION get_valuation_analytics(TIMESTAMPTZ, TIMESTAMPTZ) TO authenticated;
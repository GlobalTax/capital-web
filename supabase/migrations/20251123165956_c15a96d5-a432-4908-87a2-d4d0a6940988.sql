-- =====================================================
-- TEMPORAL: Remove auth check from get_valuation_analytics
-- Para debug del error 400
-- =====================================================
...
BEGIN
  -- ⚠️ TEMPORAL: Auth check removido para debug
  -- TODO: Restaurar check de autenticación después de confirmar que la función SQL funciona
...
-- Comentario para recordar restaurar el auth check
COMMENT ON FUNCTION public.get_valuation_analytics(timestamp with time zone, timestamp with time zone) 
IS 'TEMPORAL: Auth check removido para debug. Restaurar verificación de autenticación después de confirmar funcionamiento.';
-- Crear datos de prueba básicos (sin especificar status problemático)
...
-- 4. Lead magnets básicos (usando valor por defecto)
INSERT INTO public.lead_magnets (title, type, sector, description) VALUES 
('Guía de Valoración Empresarial', 'pdf', 'general', 'Guía completa para valorar tu empresa'),
('Checklist Due Diligence', 'pdf', 'general', 'Lista de verificación para procesos de due diligence'),
('Template Plan de Negocio', 'template', 'general', 'Plantilla profesional para plan de negocio')
ON CONFLICT DO NOTHING;
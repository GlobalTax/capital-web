-- Crear datos de prueba para Lead Scoring (corregido)
...
-- Crear los lead scores correspondientes (sin is_hot_lead ya que es generado automáticamente)
...
('visitor_consulting_001', 'strategiconsult.es', 'Strategic Consulting', 'Professional Services', '50-200', 'Sevilla', 52, 70, now() - INTERVAL '11 hours', now() - INTERVAL '5 days', 2, 'maria.ruiz@strategiconsult.es', 'María Ruiz', 'active', false),

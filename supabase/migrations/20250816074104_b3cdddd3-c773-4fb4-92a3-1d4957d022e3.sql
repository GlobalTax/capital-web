-- Improve abandonment detection with better criteria
...
BEGIN
  ...
  LOOP
    ...
    RAISE LOG 'Abandonment detected for valuation: % - Company: %, Email: %, Completion: %%, Revenue: %, EBITDA: %', 
      valuation_record.id, 
...
BEGIN
  ...
  IF TG_OP = 'UPDATE' THEN
    ...
    IF time_since_activity > INTERVAL '10 minutes' 
      ...
      RAISE LOG 'Immediate abandonment alert triggered for valuation: % - Completion: %%', 

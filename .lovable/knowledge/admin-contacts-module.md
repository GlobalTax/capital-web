...
- All changes are incremental — do NOT rebuild existing functionality
- If a change touches backend/DB or historical data, flag it and propose safest option
- Prioritize: simplicity + maintainability + visual consistency
- Success = fast triage tool with clear statuses, minimal friction
